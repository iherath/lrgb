...
def extended_cfg(cfg):
    ...
    # Torch device string used throughout the repo's train/eval code. Newer pyg replaced
    # cfg.device with cfg.accelerator/cfg.devices; main.py sets this after device selection.
    cfg.device = 'cpu'
